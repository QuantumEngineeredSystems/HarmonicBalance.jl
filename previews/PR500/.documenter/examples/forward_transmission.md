...
\frac{d}{dt} \langle c\rangle  &= \frac{-1}{2} i \Delta \langle c\rangle  -2 i \langle m\rangle  \langle c^\dagger\rangle  Vk -0.5 {\gamma}k \langle c\rangle  \\
\frac{d}{dt} \langle c^\dagger\rangle  &= 2 i Vk \langle m^\dagger\rangle  \langle c\rangle  + \frac{1}{2} i \Delta \langle c^\dagger\rangle  -0.5 \langle c^\dagger\rangle  {\gamma}k
\end{align}
