...
Differential(T, 1)(u1(T))*γ + [34m2[39mDifferential(T, 1)(v1(T))*ω - [34m([39m[34m1//2[39m[34m)[39m*u1(T)*λ - u1(T)*(ω^[34m2[39m) + u1(T)*(ω₀^[34m2[39m) + v1(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α ~ [34m0[39m

Differential(T, 1)(v1(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u1(T))*ω + [34m([39m[34m1//2[39m[34m)[39m*v1(T)*λ - u1(T)*γ*ω - v1(T)*(ω^[34m2[39m) + v1(T)*(ω₀^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α ~ [34m0[39m
...
OrderedCollections.OrderedDict{Num, ComplexF64} with 7 entries:
  u1 => 8.86467e-226+0.0im
  v1 => -3.48255e-226-1.18196e-225im
  ω  => 0.99+0.0im
  λ  => 1.0e-6+0.0im
  ω₀ => 1.0+0.0im
  γ  => 0.002+0.0im
