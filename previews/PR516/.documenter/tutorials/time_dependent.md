...
Differential(T, 1)(u1(T))*γ + [34m2[39mDifferential(T, 1)(v1(T))*ω - u1(T)*(ω^[34m2[39m) + u1(T)*(ω0^[34m2[39m) + v1(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*Differential(T, 1)(u1(T))*(u1(T)^[34m2[39m)*η + [34m([39m[34m1//2[39m[34m)[39m*Differential(T, 1)(v1(T))*u1(T)*v1(T)*η + [34m([39m[34m1//4[39m[34m)[39m*Differential(T, 1)(u1(T))*(v1(T)^[34m2[39m)*η + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α - [34m([39m[34m1//2[39m[34m)[39m*u1(T)*λ*(ω0^[34m2[39m) + [34m([39m[34m1//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*η*ω + [34m([39m[34m1//4[39m[34m)[39m*(v1(T)^[34m3[39m)*η*ω ~ F*cos(θ)

Differential(T, 1)(v1(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u1(T))*ω - u1(T)*γ*ω - v1(T)*(ω^[34m2[39m) + v1(T)*(ω0^[34m2[39m) + [34m([39m[34m1//4[39m[34m)[39m*Differential(T, 1)(v1(T))*(u1(T)^[34m2[39m)*η + [34m([39m[34m1//2[39m[34m)[39m*Differential(T, 1)(u1(T))*u1(T)*v1(T)*η + [34m([39m[34m3//4[39m[34m)[39m*Differential(T, 1)(v1(T))*(v1(T)^[34m2[39m)*η + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α + [34m([39m[34m1//2[39m[34m)[39m*v1(T)*λ*(ω0^[34m2[39m) - [34m([39m[34m1//4[39m[34m)[39m*(u1(T)^[34m3[39m)*η*ω - [34m([39m[34m1//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*η*ω ~ -F*sin(θ)
