...
Differential(t, 2)(x(t)) + Differential(t, 1)(x(t))*γ + x(t)*(ω0^[34m2[39m) + (x(t)^[34m3[39m)*α ~ F*cos(t*ω)
...
Differential(T, 1)(u1(T))*γ + [34m2[39mDifferential(T, 1)(v1(T))*ω - u1(T)*(ω^[34m2[39m) + u1(T)*(ω0^[34m2[39m) + v1(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α ~ F

Differential(T, 1)(v1(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u1(T))*ω - u1(T)*γ*ω - v1(T)*(ω^[34m2[39m) + v1(T)*(ω0^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α ~ [34m0[39m
...
100-element Vector{Vector{ComplexF64}}:
 [0.05201825268854886 - 1.5345462870686367e-33im, NaN + NaN*im, NaN + NaN*im]
 [0.05350409873601037 - 7.187934492055819e-43im, NaN + NaN*im, NaN + NaN*im]
 [0.05507950952558317 + 2.5969141668968596e-48im, NaN + NaN*im, NaN + NaN*im]
 [0.05675239575459291 + 6.165772834148213e-36im, NaN + NaN*im, NaN + NaN*im]
 [0.058531557933164446 + 1.9283143889830357e-37im, NaN + NaN*im, NaN + NaN*im]
 [0.06042680006976527 + 5.162745495962694e-48im, NaN + NaN*im, NaN + NaN*im]
 [0.0624490572242802 - 2.6732104897799117e-43im, NaN + NaN*im, NaN + NaN*im]
 [0.06461053756748154 - 1.8341019240410886e-34im, NaN + NaN*im, NaN + NaN*im]
 [0.06692487893821525 - 1.1379473232287326e-36im, NaN + NaN*im, NaN + NaN*im]
 [0.06940731879175727 - 2.8859804107784234e-45im, NaN + NaN*im, NaN + NaN*im]
 ⋮
 [0.7208945671058409 - 3.574653461436748e-59im, 0.0261730047987944 + 2.1820166035077152e-46im, NaN + NaN*im]
 [0.7272065484880825 - 7.975145115624479e-54im, 0.02569212388375471 + 1.4241932834298904e-39im, NaN + NaN*im]
 [0.7334774314184077 + 2.702733176330675e-37im, 0.02522748187697229 - 5.602702096643356e-45im, NaN + NaN*im]
 [0.7397074914670921 - 1.1193070201398063e-36im, 0.024778270139119485 + 1.645600604942821e-46im, NaN + NaN*im]
 [0.7458968612891713 - 2.6467493495056007e-41im, 0.024343733154166262 + 4.98335401481782e-50im, NaN + NaN*im]
 [0.7520454974269711 + 1.5766349387181503e-45im, 0.02392316420636251 + 2.6716797510288913e-51im, NaN + NaN*im]
 [0.7581531325641624 + 7.067626330230805e-34im, 0.02351590147594373 + 2.2411936613586065e-44im, NaN + NaN*im]
 [0.7642192050744052 - 5.094272250616828e-69im, 0.023121324506598668 - 1.7448925014840844e-46im, NaN + NaN*im]
 [0.7702427516658309 - 1.4517033386038388e-40im, 0.022738851003713957 + 3.222906010698136e-53im, NaN + NaN*im]
```
...
Differential(T, 1)(u1(T))*γ + [34m2[39mDifferential(T, 1)(v1(T))*ω - u1(T)*(ω^[34m2[39m) + u1(T)*(ω0^[34m2[39m) + v1(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*u2(T)*α + [34m([39m[34m3//2[39m[34m)[39m*u1(T)*(u2(T)^[34m2[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α + [34m([39m[34m3//2[39m[34m)[39m*u1(T)*v1(T)*v2(T)*α + [34m([39m[34m3//2[39m[34m)[39m*u1(T)*(v2(T)^[34m2[39m)*α - [34m([39m[34m3//4[39m[34m)[39m*u2(T)*(v1(T)^[34m2[39m)*α ~ F

Differential(T, 1)(v1(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u1(T))*ω - u1(T)*γ*ω - v1(T)*(ω^[34m2[39m) + v1(T)*(ω0^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v2(T)*α - [34m([39m[34m3//2[39m[34m)[39m*u1(T)*u2(T)*v1(T)*α + [34m([39m[34m3//2[39m[34m)[39m*(u2(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α - [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m2[39m)*v2(T)*α + [34m([39m[34m3//2[39m[34m)[39m*v1(T)*(v2(T)^[34m2[39m)*α ~ [34m0[39m

Differential(T, 1)(u2(T))*γ + [34m([39m[34m6//1[39m[34m)[39m*Differential(T, 1)(v2(T))*ω - [34m([39m[34m9//1[39m[34m)[39m*u2(T)*(ω^[34m2[39m) + u2(T)*(ω0^[34m2[39m) + [34m([39m[34m3//1[39m[34m)[39m*v2(T)*γ*ω + [34m([39m[34m1//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//2[39m[34m)[39m*(u1(T)^[34m2[39m)*u2(T)*α - [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*(u2(T)^[34m3[39m)*α + [34m([39m[34m3//2[39m[34m)[39m*u2(T)*(v1(T)^[34m2[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u2(T)*(v2(T)^[34m2[39m)*α ~ [34m0[39m

Differential(T, 1)(v2(T))*γ - [34m([39m[34m6//1[39m[34m)[39m*Differential(T, 1)(u2(T))*ω - [34m([39m[34m3//1[39m[34m)[39m*u2(T)*γ*ω - [34m([39m[34m9//1[39m[34m)[39m*v2(T)*(ω^[34m2[39m) + v2(T)*(ω0^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//2[39m[34m)[39m*(u1(T)^[34m2[39m)*v2(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(u2(T)^[34m2[39m)*v2(T)*α - [34m([39m[34m1//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α + [34m([39m[34m3//2[39m[34m)[39m*(v1(T)^[34m2[39m)*v2(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v2(T)^[34m3[39m)*α ~ [34m0[39m
