...
Differential(T, 1)(u1(T))*γ + [34m2[39mDifferential(T, 1)(v1(T))*ω - J*u2(T) - [34m([39m[34m1//2[39m[34m)[39m*u1(T)*λ - u1(T)*(ω^[34m2[39m) + u1(T)*(ω0^[34m2[39m) + v1(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u1(T)*(v1(T)^[34m2[39m)*α ~ [34m0[39m

Differential(T, 1)(v1(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u1(T))*ω - J*v2(T) + [34m([39m[34m1//2[39m[34m)[39m*v1(T)*λ - u1(T)*γ*ω - v1(T)*(ω^[34m2[39m) + v1(T)*(ω0^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u1(T)^[34m2[39m)*v1(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v1(T)^[34m3[39m)*α ~ [34m0[39m

Differential(T, 1)(u2(T))*γ + [34m2[39mDifferential(T, 1)(v2(T))*ω - J*u1(T) - [34m([39m[34m1//2[39m[34m)[39m*u2(T)*λ - u2(T)*(ω^[34m2[39m) + u2(T)*(ω0^[34m2[39m) + v2(T)*γ*ω + [34m([39m[34m3//4[39m[34m)[39m*(u2(T)^[34m3[39m)*α + [34m([39m[34m3//4[39m[34m)[39m*u2(T)*(v2(T)^[34m2[39m)*α ~ [34m0[39m

Differential(T, 1)(v2(T))*γ - [34m([39m[34m2//1[39m[34m)[39m*Differential(T, 1)(u2(T))*ω - J*v1(T) + [34m([39m[34m1//2[39m[34m)[39m*v2(T)*λ - u2(T)*γ*ω - v2(T)*(ω^[34m2[39m) + v2(T)*(ω0^[34m2[39m) + [34m([39m[34m3//4[39m[34m)[39m*(u2(T)^[34m2[39m)*v2(T)*α + [34m([39m[34m3//4[39m[34m)[39m*(v2(T)^[34m3[39m)*α ~ [34m0[39m
...
![](epgkojt.png){width=600px height=400px}
...
![](sftwvpe.png){width=600px height=400px}
