...
$$
\begin{aligned}
\partial_{t} \langle m \rangle &=  - i \mathtt{{\Omega}d} + \langle m \rangle \left(  - 0.5 \mathtt{{\gamma}m} - i \Delta \right) - \langle c \rangle^{2} \mathtt{Vk} i \\[-0.0em]
\partial_{t} \langle m^{\dagger} \rangle &= i \mathtt{{\Omega}d} + \langle m^{\dagger} \rangle \left(  - 0.5 \mathtt{{\gamma}m} + i \Delta \right) + \langle c^{\dagger} \rangle^{2} \mathtt{Vk} i \\[-0.0em]
\partial_{t} \langle c \rangle &= \langle c \rangle \left(  - 0.5 \mathtt{{\gamma}k} - 0.5 i \Delta \right) - 2 \mathtt{Vk} \langle m \rangle \langle c^{\dagger} \rangle i \\[-0.0em]
\partial_{t} \langle c^{\dagger} \rangle &= \langle c^{\dagger} \rangle \left(  - 0.5 \mathtt{{\gamma}k} + 0.5 i \Delta \right) + 2 \mathtt{Vk} \langle m^{\dagger} \rangle \langle c \rangle i
\end{aligned}
...
-mᵢ(t)*Δ - [34m0.5[39mmᵣ(t)*γm - [34m2[39mVk*cᵢ(t)*cᵣ(t) ~ Differential(t, 1)(mᵣ(t))

Ωd - [34m0.5[39mmᵢ(t)*γm + mᵣ(t)*Δ - Vk*(cᵢ(t)^[34m2[39m) + Vk*(cᵣ(t)^[34m2[39m) ~ Differential(t, 1)(mᵢ(t))

-[34m0.5[39mcᵢ(t)*Δ - [34m0.5[39mcᵣ(t)*γk + [34m2[39mVk*cᵢ(t)*mᵣ(t) - [34m2[39mVk*cᵣ(t)*mᵢ(t) ~ Differential(t, 1)(cᵣ(t))

-[34m0.5[39mcᵢ(t)*γk + [34m0.5[39mcᵣ(t)*Δ + [34m2[39mVk*cᵢ(t)*mᵢ(t) + [34m2[39mVk*cᵣ(t)*mᵣ(t) ~ Differential(t, 1)(cᵢ(t))
