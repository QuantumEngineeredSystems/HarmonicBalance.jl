...
```ansi
2-element Vector{SecondQuantizedAlgebra.Op}:
 a
 a'
```
...
$$
\begin{aligned}
\partial_{t} \langle a \rangle &= G \langle a^{\dagger} \rangle i + \left(  - 0.5 \kappa + \left(  - U + \Delta \right) i \right) \langle a \rangle - \langle a \rangle^{2} U \langle a^{\dagger} \rangle i \\[-0.0em]
\partial_{t} \langle a^{\dagger} \rangle &=  - G \langle a \rangle i + \left(  - 0.5 \kappa + \left( U - \Delta \right) i \right) \langle a^{\dagger} \rangle + \langle a^{\dagger} \rangle^{2} U \langle a \rangle i
\end{aligned}
