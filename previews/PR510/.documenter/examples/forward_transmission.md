...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -1 i {\Omega}d -1 i \Delta \langle m\rangle  -0.5 {\gamma}m \langle m\rangle  -1 i \langle c\rangle ^{2} Vk \\
...
\frac{d}{dt} \langle c\rangle  &= -0.5 \langle c\rangle  {\gamma}k -2 i Vk \langle c^\dagger\rangle  \langle m\rangle  + \frac{-1}{2} i \Delta \langle c\rangle  \\
