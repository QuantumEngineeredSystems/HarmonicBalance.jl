...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -1 i \langle m\rangle  \Delta -0.5 {\gamma}m \langle m\rangle  -1 i {\Omega}d -1 i \langle c\rangle ^{2} Vk \\
...
\frac{d}{dt} \langle c^\dagger\rangle  &= \frac{1}{2} i \Delta \langle c^\dagger\rangle  + 2 i \langle c\rangle  Vk \langle m^\dagger\rangle  -0.5 {\gamma}k \langle c^\dagger\rangle 
\end{align}
