...
\begin{align}
\frac{d}{dt} \langle a\rangle  &= G \mathit{i} \langle a^\dagger\rangle  -0.5 \kappa \langle a\rangle  - U \mathit{i} \langle a^\dagger\rangle  \langle a\rangle ^{2} + \left(  - U + \Delta \right) \mathit{i} \langle a\rangle  \\
\frac{d}{dt} \langle a^\dagger\rangle  &= -0.5 \langle a^\dagger\rangle  \kappa + \left( U - \Delta \right) \mathit{i} \langle a^\dagger\rangle  + U \mathit{i} \langle a^\dagger\rangle ^{2} \langle a\rangle  - G \mathit{i} \langle a\rangle 
\end{align}
