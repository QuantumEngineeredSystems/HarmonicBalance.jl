...
\frac{d}{dt} \langle m^\dagger\rangle  &= 1 i \langle c^\dagger\rangle ^{2} Vk + 1 i {\Omega}d -0.5 {\gamma}m \langle m^\dagger\rangle  + 1 i \Delta \langle m^\dagger\rangle  \\
\frac{d}{dt} \langle c\rangle  &= -2 i \langle c^\dagger\rangle  Vk \langle m\rangle  + \frac{-1}{2} i \Delta \langle c\rangle  -0.5 {\gamma}k \langle c\rangle  \\
\frac{d}{dt} \langle c^\dagger\rangle  &= \frac{1}{2} i \Delta \langle c^\dagger\rangle  + 2 i \langle c\rangle  Vk \langle m^\dagger\rangle  -0.5 \langle c^\dagger\rangle  {\gamma}k
\end{align}
