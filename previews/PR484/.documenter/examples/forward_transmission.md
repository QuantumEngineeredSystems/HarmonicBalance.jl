...
\frac{d}{dt} \langle c^\dagger\rangle  &= 2 i Vk \langle m^\dagger\rangle  \langle c\rangle  -0.5 {\gamma}k \langle c^\dagger\rangle  + \frac{1}{2} i \Delta \langle c^\dagger\rangle 
\end{align}
