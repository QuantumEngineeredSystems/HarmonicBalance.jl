...
\frac{d}{dt} \langle a^\dagger\rangle  &=  - G \mathit{i} \langle a\rangle  + \left( U - \Delta \right) \mathit{i} \langle a^\dagger\rangle  + U \mathit{i} \langle a\rangle  \langle a^\dagger\rangle ^{2} -0.5 \kappa \langle a^\dagger\rangle 
\end{align}
