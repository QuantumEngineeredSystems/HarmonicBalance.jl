...
\frac{d}{dt} \langle c\rangle  &= -0.5 \langle c\rangle  {\gamma}k + \frac{-1}{2} i \Delta \langle c\rangle  -2 i \langle c^\dagger\rangle  \langle m\rangle  Vk \\
\frac{d}{dt} \langle c^\dagger\rangle  &= \frac{1}{2} i \Delta \langle c^\dagger\rangle  -0.5 \langle c^\dagger\rangle  {\gamma}k + 2 i \langle c\rangle  \langle m^\dagger\rangle  Vk
\end{align}
