...
\begin{align}
\frac{d}{dt} \langle a\rangle  &= -0.5 \langle a\rangle  \kappa + G \mathit{i} \langle a^\dagger\rangle  + \left(  - U + \Delta \right) \mathit{i} \langle a\rangle  - U \mathit{i} \langle a^\dagger\rangle  \langle a\rangle ^{2} \\
