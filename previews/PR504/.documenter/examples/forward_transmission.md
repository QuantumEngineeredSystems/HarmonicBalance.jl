...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -1 i \Delta \langle m\rangle  -1 i \langle c\rangle ^{2} Vk -0.5 {\gamma}m \langle m\rangle  -1 i {\Omega}d \\
...
\frac{d}{dt} \langle c\rangle  &= \frac{-1}{2} i \langle c\rangle  \Delta -0.5 \langle c\rangle  {\gamma}k -2 i Vk \langle c^\dagger\rangle  \langle m\rangle  \\
