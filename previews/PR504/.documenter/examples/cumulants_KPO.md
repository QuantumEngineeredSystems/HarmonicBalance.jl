...
\begin{align}
\frac{d}{dt} \langle a\rangle  &= \left(  - U + \Delta \right) \mathit{i} \langle a\rangle  + G \mathit{i} \langle a^\dagger\rangle  - U \mathit{i} \langle a^\dagger\rangle  \langle a\rangle ^{2} -0.5 \langle a\rangle  \kappa \\
