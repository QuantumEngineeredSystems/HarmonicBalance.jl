...
\frac{d}{dt} \langle m^\dagger\rangle  &= 1 i \Delta \langle m^\dagger\rangle  -0.5 {\gamma}m \langle m^\dagger\rangle  + 1 i \langle c^\dagger\rangle ^{2} Vk + 1 i {\Omega}d \\
\frac{d}{dt} \langle c\rangle  &= \frac{-1}{2} i \langle c\rangle  \Delta -0.5 \langle c\rangle  {\gamma}k -2 i \langle c^\dagger\rangle  Vk \langle m\rangle  \\
\frac{d}{dt} \langle c^\dagger\rangle  &= 2 i \langle c\rangle  Vk \langle m^\dagger\rangle  + \frac{1}{2} i \Delta \langle c^\dagger\rangle  -0.5 \langle c^\dagger\rangle  {\gamma}k
\end{align}
