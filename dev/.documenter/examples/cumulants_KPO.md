...
\frac{d}{dt} \langle a^\dagger\rangle  &= U \mathit{i} \langle a^\dagger\rangle ^{2} \langle a\rangle  -0.5 \langle a^\dagger\rangle  \kappa + \left( U - \Delta \right) \mathit{i} \langle a^\dagger\rangle  - G \mathit{i} \langle a\rangle 
\end{align}
