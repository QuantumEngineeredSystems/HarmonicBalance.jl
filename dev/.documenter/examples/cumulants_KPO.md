...
\begin{align}
\frac{d}{dt} \langle a\rangle  &=  - U \mathit{i} \langle a^\dagger\rangle  \langle a\rangle ^{2} -0.5 \kappa \langle a\rangle  + G \mathit{i} \langle a^\dagger\rangle  + \left(  - U + \Delta \right) \mathit{i} \langle a\rangle  \\
