...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -1 i \Delta \langle m\rangle  -1 i {\Omega}d -0.5 {\gamma}m \langle m\rangle  -1 i \langle c\rangle ^{2} Vk \\
\frac{d}{dt} \langle m^\dagger\rangle  &= -0.5 {\gamma}m \langle m^\dagger\rangle  + 1 i {\Omega}d + 1 i \Delta \langle m^\dagger\rangle  + 1 i Vk \langle c^\dagger\rangle ^{2} \\
\frac{d}{dt} \langle c\rangle  &= -2 i \langle m\rangle  Vk \langle c^\dagger\rangle  -0.5 {\gamma}k \langle c\rangle  + \frac{-1}{2} i \Delta \langle c\rangle  \\
