...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -0.5 {\gamma}m \langle m\rangle  -1 i \langle c\rangle ^{2} Vk -1 i {\Omega}d -1 i \Delta \langle m\rangle  \\
...
\frac{d}{dt} \langle c^\dagger\rangle  &= \frac{1}{2} i \Delta \langle c^\dagger\rangle  + 2 i \langle m^\dagger\rangle  \langle c\rangle  Vk -0.5 {\gamma}k \langle c^\dagger\rangle 
\end{align}
