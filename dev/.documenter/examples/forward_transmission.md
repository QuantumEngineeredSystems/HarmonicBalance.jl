...
\frac{d}{dt} \langle c\rangle  &= -0.5 {\gamma}k \langle c\rangle  + \frac{-1}{2} i \Delta \langle c\rangle  -2 i \langle c^\dagger\rangle  \langle m\rangle  Vk \\
\frac{d}{dt} \langle c^\dagger\rangle  &= -0.5 \langle c^\dagger\rangle  {\gamma}k + \frac{1}{2} i \langle c^\dagger\rangle  \Delta + 2 i Vk \langle c\rangle  \langle m^\dagger\rangle 
\end{align}
