...
\begin{align}
\frac{d}{dt} \langle m\rangle  &= -1 i {\Omega}d -0.5 {\gamma}m \langle m\rangle  -1 i Vk \langle c\rangle ^{2} -1 i \Delta \langle m\rangle  \\
\frac{d}{dt} \langle m^\dagger\rangle  &= 1 i {\Omega}d -0.5 {\gamma}m \langle m^\dagger\rangle  + 1 i \Delta \langle m^\dagger\rangle  + 1 i \langle c^\dagger\rangle ^{2} Vk \\
\frac{d}{dt} \langle c\rangle  &= \frac{-1}{2} i \Delta \langle c\rangle  -0.5 {\gamma}k \langle c\rangle  -2 i \langle m\rangle  \langle c^\dagger\rangle  Vk \\
\frac{d}{dt} \langle c^\dagger\rangle  &= 2 i Vk \langle c\rangle  \langle m^\dagger\rangle  + \frac{1}{2} i \Delta \langle c^\dagger\rangle  -0.5 \langle c^\dagger\rangle  {\gamma}k
\end{align}
